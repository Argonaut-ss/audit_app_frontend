      ...
      <div className="grid grid-cols-3 text-center">
        ...
        <div>
          ...
          <p className="mt-1 font-poppins text-sm text-[#26364D]">
            {formatDate(profilKlien.WaktuPeriode)}
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mt-1 font-poppins text-sm text-[#26364D]">
            {formatDate(profilKlien.WaktuMulai)}
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mt-1 font-poppins text-sm text-[#26364D]">
            {formatDate(profilKlien.BatasWaktu)}
          </p>
        </div>
