  ...
  return (
    <div ref={dropdownRef} className={`relative w-full ${className}`}>
      ...
      <button
        ...
        className={`flex min-h-10 w-full items-center justify-between gap-3 rounded-lg border border-[#DCE5EF] bg-white px-4 text-left font-poppins text-sm text-[#596275] outline-none transition hover:border-[#38BDF8] focus:border-[#38BDF8] disabled:cursor-not-allowed disabled:bg-[#F8FAFC] disabled:opacity-60 ${triggerClassName}`}
        >
